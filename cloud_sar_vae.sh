#!/bin/bash
#SBATCH --job-name="cloud_sar_vae_v2"              # Name of the job
#SBATCH -p gpu                                    # Name of the partition: available options "standard, standard-low, gpu, hm"
#SBATCH --error=cloud_sar_vae_v2.err                 # Name of stderr error file
#SBATCH --output=cloud_sar_vae_v2.out                # Name of stdout output file
...
exe="/scratch/21ec39053/MTP/vae_sar_training.py"                       # Change to the path of your Python script
