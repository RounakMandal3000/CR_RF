#!/bin/bash
#SBATCH --job-name="rf_training_v1"              # Name of the job
#SBATCH -p gpu                                    # Name of the partition: available options "standard, standard-low, gpu, hm"
#SBATCH --error=rf_training_v1.err                 # Name of stderr error file
#SBATCH --output=rf_training_v1.out                # Name of stdout output file
...
exe="/scratch/21ec39053/MTP/rf_training.py"                       # Change to the path of your Python script
